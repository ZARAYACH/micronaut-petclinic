...
class ClinicServiceGeoTest {
    ...
    @Test
    void shouldFindClinicsIntersectingBounds() {
        Collection<Clinic> clinics = clinicService.findClinicsIntersectingBounds(-89.55, 43.00, -89.20, 43.20);
        assertThat(clinics).isNotEmpty();
        assertThat(clinics).extracting(Clinic::name)
                .contains("West Madison Pet Clinic", "Sun Prairie Pet Clinic")
                .doesNotContain("Janesville Pet Clinic");
    }
}
